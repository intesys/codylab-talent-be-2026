...
public class BeanConfiguration {
    ...
    @Bean
    public ActivityRepository createActivityRepository(DataSource dataSource) {return new ActivityRepository(dataSource);}
    ...
    @Bean
    public TrackingRepository createTrackingRepository(DataSource dataSource) {return new TrackingRepository(dataSource);}

    @Bean
    public TrackingService createTrackingService(TrackingRepository trackingRepository, ActivityRepository activityRepository, ProjectRepository projectRepository) {
